...
function openModalWithGuid(guid) {
    ...
    $.ajax({
        ...
        success: function (category) {
            ...
            document.getElementById('editCategoryName').value = category.data.CategoryName;
            document.getElementById('editCategoryGuid').value = category.data.Guid;
...
function updateCategory() {
    ...
    var guid = document.getElementById('editCategoryGuid').value;
    var model = { CategoryName: categoryName, Guid: guid };
    // AJAX isteği ile kategoriyi güncelle
    $.ajax({
        url: '/Categories/Update',
        type: 'POST',
        data: { guid: guid, categoryName: categoryName },
        success: function (response) {
            if (response.success) {
...
function handleCheckboxChange(checkboxElement) {
    ...
    $.ajax({
        url: '/Categories/UpdateStatus', // AJAX isteğinin gönderileceği URL
        type: 'POST',
