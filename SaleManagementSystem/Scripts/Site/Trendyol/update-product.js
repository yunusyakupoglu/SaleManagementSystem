...
document.addEventListener('DOMContentLoaded', function () {
    console.log(selectedAttributes, "selectedAttributes from get product");
...
async function updateProducts() {
    ...
    console.log(putRequest.items[0].images, "putRequest.items[0].images");
            ...
            if (data.StatusCode == 200) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.StatusCode == 200) {
                            $.ajax({
                                url: 'http://localhost:64238/trendyol/urun-guncelle',
                                type: 'PUT',
                                data: JSON.stringify(putRequest), // JSON olarak gönderilecek data,
                                contentType: 'application/json',
                                headers: {
